...
export const chats: Chat[] = [
  ...
  },
  {
    id: 'maya',
    name: 'Майя',
    avatar: 'linear-gradient(135deg,#ff8a5b,#ff6a3d)',
    avatarText: 'M',
    date: 'Jun 12',
    preview: '😭',
    sent: true,
    ...
    messages: [
      ...
      { type: 'text', out: true, text: 'приветэ', time: '23:36', status: 'read' },
      { type: 'sticker', out: true, emoji: '😌', time: '23:36', status: 'read' },
      { type: 'text', out: true, text: 'а что непристойности не будешь писать', time: '23:36', status: 'read' },
      { type: 'text', out: true, text: 'ахаха', time: '23:36', status: 'read' },
      { type: 'text', out: false, text: 'Вхахха, как и обещала 😇', time: '23:52' },
      { type: 'sticker', out: true, emoji: '🙂', time: '23:52', status: 'sent' },
      { type: 'text', out: true, text: 'Эх', time: '23:53', status: 'sent' },
      { type: 'sticker', out: true, emoji: '😭', time: '23:55', status: 'sent' },
    ],
  },
  {
    id: 'artem',
